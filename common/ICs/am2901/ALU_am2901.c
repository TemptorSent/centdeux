...
static inline nibble_t am2901_read_Rmux(am2901_device_t *dev) {
	switch(dev->Rmux) {
...
static inline nibble_t am2901_read_Smux(am2901_device_t *dev) {
	switch(dev->Smux) {
		case 0: case 'Z': case '0': return(0);
...
static inline nibble_t am2901_read_RAMmux(am2901_device_t *dev) {
...
static inline nibble_t am2901_read_Qmux(am2901_device_t *dev) {
...
static inline nibble_t am2901_readYmux(am2901_device_t *dev) {
	return( (dev->Ymux=='A'?dev->A:dev->F) & 0xf);
}


static inline char *am2901_source_operand_decode(am2901_device_t *dev) {
...
static inline char *am2901_destination_decode(am2901_device_t *dev) {
...
static inline char *am2901_function_decode(am2901_device_t *dev) {
